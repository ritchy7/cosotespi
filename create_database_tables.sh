...
sudo -u postgres psql -c "CREATE USER vagrant PASSWORD '1234';"
sudo -u postgres psql -c "ALTER ROLE vagrant SUPERUSER;"
sudo -u postgres psql -c "CREATE DATABASE restaurant WITH ENCODING='UTF8' OWNER=vagrant;"

# Create tables.
PGPASSWORD=1234 psql -U vagrant restaurant -c '
